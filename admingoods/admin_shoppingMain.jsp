...
<!--▶▶메뉴바 형태로 만들었으면 좋겠는데  -->
	...
	<!-- 위에 있는 form테그를 아래와 같이 수정합니다. 
	기능이 안먹히면 아래  <div class="tab_wrap"></div> 까지는 주석처리 하고
	위의 코드로 다시 수정하면 됩니다. - 백성진 - -->
	 <div class="tab_wrap">
	<form action="" name="item" method="get">
				<ul class="tabs" >
					<li class="tabSelect tabSelectDate on">
					<a href="./AdminGoodsList.ag?">
						<span>전체보기</span></a>
					</li>
					<!-- <li class="tabSelect tabSelectTheme">
					<a href="./AdminGoodsList.ag?item=meal">
						<span>밀키트</span></a>
					</li>
					<li class="tabSelect tabSelectTheme">
					<a href="./AdminGoodsList.ag?item=veg">
						<span>식재료</span></a>
					</li>	
					<li class="tabSelect tabSelectTheme">
					<a href="./AdminGoodsList.ag?item=tool">
						<span>주방용품</span></a>
					</li> -->
					<!--li 테그들은 안먹힘~ 이유가 뭐지?? 04.04 -->			
				</ul>
				</form>
			</div> 
	...
	%>
		<td>
			<img src="./upload/<%=gb.getF_gs_img().split(",")[0] %>" width="250" height="300"><br>
			<a href=""><%=gb.getF_gs_name() %></a><br>
			<%=gb.getF_gs_price() %>원<br>	
		  	<a href="#" onclick="window.open('./AdminGoodsModify.ag?num=<%=gb.getF_gs_num()%>', '_blanck','width=400, height=600'); return false">수정</a>	 	
			/
