...
<link rel="stylesheet" type="text/css" href="./cjkit/web/css/reWriteCSS/gr_rvMy.css">
...
<body>
	...
	<section class="sec_review">
		<div><h1 class="h1_title">내가 쓴 리뷰<h1><div>
		<div class="div_review">
			...
			<div class="div_tab">
				<table class="tab_review" border="1">
					...
					<tr>
						<th>image</th>
						<td><img src="./upload/<%=rb.getF_grv_img().split(",")[0]%>"
							width="130" height="150"></td>
					</tr>
					<%
						} else {
				...
				<input type="button" value="내 리뷰로 이동하기"
					onclick="location.href='./GoodResContentAction.gr?num=<%=rb.getF_grv_gr_num()%>'">
			</div>
			<%
				}
			%>
