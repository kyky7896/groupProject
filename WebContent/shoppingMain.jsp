...
$(function(){
  $('li:nth-child(1)').on('click', function(){
    $('li:nth-child(1)').addClass('tabSelect tabSelectDate on');
    $('li:nth-child(2)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(3)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(4)').addClass('tabSelect tabSelectTheme');
  });
  
  $('li:nth-child(2)').on('click', function(){
    $('li:nth-child(1)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(2)').addClass('tabSelect tabSelectDate on');
    $('li:nth-child(3)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(4)').addClass('tabSelect tabSelectTheme');
  });
  ...
  $('li:nth-child(3)').on('click', function(){
    $('li:nth-child(1)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(2)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(3)').addClass('tabSelect tabSelectDate on');
    $('li:nth-child(4)').addClass('tabSelect tabSelectTheme');
  });
  ...
  $('li:nth-child(4)').on('click', function(){
    ...
    $('li:nth-child(2)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(3)').addClass('tabSelect tabSelectTheme');
    $('li:nth-child(4)').addClass('tabSelect tabSelectDate on');
  });
});
</script>
<!-- select js -->
			...
			<div id="content" class="ev_content">
				...
				<div class="ev_wrap">
					...
					<%
						...
						%>
		<!-- 			<a href="./BasketList.ba"><b>장바구니</b></a> -->
		<!-- 장바구니는 팝업으로 대체 합니다. - 백성진 -  -->
			...
			<div class="tab_wrap">
				<ul class="tabs">
					...
					<li>
					<a href="./GoodsList.go?item=meal">
						<span>밀키트</span></a>
					</li>
					<li>
					<a href="./GoodsList.go?item=veg">
						<span>식재료</span></a>
					</li>	
					<li>
					<a href="./GoodsList.go?item=tool">
						<span>주방용품</span></a>
					</li>	
          <%
          ...
          function sel(){
            document.form.submit();
					...
					<form action="./GoodsList.go?item=<%=item %>" name="form" style="float: right;">
            <input type="hidden" name="item" value="<%=item %>">
						<select name="type" id="sele" onchange="sel();">
							<option value="latest"
              <% 
              ...
              >낮은가격순</option>
						...
						<tr>
							<%
					    	  for(int b=0;b<col;b++){
					    		...
					    		%>
							<td><img src="./upload/<%=gb.getF_gs_img().split(",")[0] %>"width="250" height="300"><br> 
							<%-- <a href="./GoodsDetail.go?num=<%=gb.getF_gs_num() %>"> <%=gb.getF_gs_name() %></a> <br>  --%>
							<a href="#" onclick="window.open('./GoodsDetail.go?num=<%=gb.getF_gs_num() %>', '_blanck','width=800, height=650'); return false"><%=gb.getF_gs_name() %>
							</a><br>
							<%=gb.getF_gs_price() %>원<br></td>
							<%
					    		num++;
					    		if(size<=num) break;
					    	  }
				...
				<!-- 기본 디자인에서 필요 없을듯 하여 주석처리 합니다. -백성진- -->		
