...
<body>
	...
	<div id="wrap">
		...
		<div class="div001"><label>MY PAGE</label></div>
 	<div class="div002">
<!--		<label class="div02_lab01">레시피 : 10</label>
		<label class="div02_lab02">좋아요 : 6</label> -->
	</div><br> 
	<div class="div03">
		<table class="tab001">
			<tr>
				<th onclick="location.href='./MyRecipeList.re'">
				<img src="./member/knife.png"><br>
				내가 쓴 레시피
				</th>
				<th onclick="location.href='./ReviewMy.rv'">
				<img src="./member/res.png"><br>
				내가 쓴 맛집 리뷰</th> 
				<th onclick="location.href='./MemberUpdate.me'" rowspan="2">
				<img src="./member/modify.png"><br>
				회원 정보 수정</th>
			</tr>		
			<tr>
				<th onclick="location.href='./GoodsList.go'">
				<img src="./member/shop.png"><br>
				쇼핑몰로 이동</th>
				<th onclick="location.href='./OrderList.or'">
				<img src="./member/order.png"><br>
				쇼핑몰 주문 목록</th>
			</tr>
			...
			%>
			<tr>
				<th onclick="location.href='./GoodsAdd.ag'">
				<img src="./member/product.png"><br>
				쇼핑몰 상품 등록
				</th>
				<th onclick="location.href='./AdminGoodsList.ag'">
				<img src="./member/admin.png"><br>
				관리자 상품 목록 리스트
				</th>
				<th rowspan="2" onclick="location.href='./ChartList.me'"><img src="./member/chart.png"><br>
				통계자료</th>				
			</tr>
			<tr>
				<th onclick="location.href='./MemberList.me'">
				<img src="./member/user.png"><br>
				회원 목록
				</th>
				<th onclick="location.href='./AdminOrderList.ao'">
				<img src="./member/orderList.png"><br>
				사용자 주문 목록 리스트(관리자)
				</th>
