...
<body>
	...
	<div class="div001"><label>마이 페이지</label></div>
	<div class="div002">
	...
	<div class="div03">
		<table class="tab001">
			<tr>
				...
				<a href="./ReviewMy.rv">내가 쓴 맛집 리뷰</a></th>
				<th>찜목록</th>
			</tr>		
			<tr>
				<th onclick="location.href='./MemberUpdate.me'">
			...
			%>
			<tr>
				<td onclick="location.href='./GoodsAdd.ag'">쇼핑몰 상품등록</td>
				<td onclick="location.href='./AdminGoodsList.ag'">관리자 상품목록리스트</td>
				<td></td>				
			</tr>
			<tr>
				<td onclick="location.href='./MemberList.me'">회원목록</td>
				<td onclick="location.href='./OrderList.or'">쇼핑몰 주문목록</td>
				<td onclick="location.href='./AdminOrderList.ao'">사용자 주문목록 리스트(관리자)</td>
