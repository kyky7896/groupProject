...
<!-- 스크립트 경로가 기존의 작성된 코드와 너무 멀어서 변경합니다 .기존 코드는 주석 처리 합니다. - 백성진 - -->
...
//1)스크립트 선언부위는 가까울수록 좋습니다. 2) 절대경로를 못찾을것 같아서 SDN 방식으로 변경합니다.
//3)기존에 작성된 파일은 recipeDetail_backup.jsp 으로 변경해서 파일을 넣어두었습니다.-백성진- 
// 로그인X - 댓글 창 클릭/
/* function loginPopup() {
