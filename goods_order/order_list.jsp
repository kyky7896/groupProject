	...
	<div id="wrap">
		...
		<section id="container">
			...
			<div id="content" class="ev_content">
				...
				<div class="ev_wrap">
					<h1 class="title" align="center">주문 목록</h1><br>
						...
						<!--(팀프로젝트 쇼핑몰 리스트) 여기서부터 본문 시작입니다. -->
								...
								<table border="1">
								  ...
								  <tr>
									<td>
  									<a href="#" onclick="window.open('./OrderDetail.or?trade_num=<%=ob.getF_or_trade_num() %>', '_blanck','width=500, height=600'); return false">	 	
                    ...
                    <%=ob.getF_or_gs_name() %>
								  ...
								  <a href="./MemberMyPageAction.me" style="font-size: 18px;">&nbsp;&nbsp;<b>마이페이지 이동</b> </a>
